...
// app.get('/',(req, res)=>{
    ...
    // ceci est un exemple pour insérer la valeur dans la database, et cela fonctionne
    // const sqlInsert = "INSERT INTO movie_reviews(movieName, moviReview) VALUES ('inception', 'good movie');"
    // db.query(sqlInsert, (err,result)=>{
    //     res.send('Hello i pedro');
    // })
